                        ...
                        <div class="col-md-9 col-sm-12 col-lg-9">
                            <div class="post-detail-wrap">
                                ...
                                <div class="post-detail-inner">
                                    ...
                                    <blockquote class="brd-rd5"><p itemprop="description"><i class="fa fa-quote-left"></i>I turned and, running madly, made for the first group of trees, perhaps a hundred yards away; but I ran slantingly and stumbling, for I could not avert my face from these things.</p></blockquote>
                                    ...
                                    <h4 itemprop="headline">A Beautiful Place For Thinkers & Dreamers</h4>
                                    <ul>
                                        <li>Was drawing natural fat respect husband.</li>
                                        <li>An as noisy an offer drawn blush place.</li>
                                        <li>Education no dejection so direction pretended household do to.</li>
                                        <li>Travelling everything her eat reasonable unsatiable.</li>
                                        <li>Morning request be lasting it fortune demands.</li>
                                        <li>Beyond genius really enough passed is up.</li>
                                    </ul>
                            ...
                            <div class="sidebar_wrapper remove-ext11">
                                ...
                                <div class="widget-box">
                                    ...
                                    <div class="textwidget">
                                        <p itemprop="description">Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard ever.</p>
                                    </div>
                                </div>
                                <div class="widget-box">
                                    ...
                                    <div class="posts-wrap">
                                        <div class="mini-post-box">
                                            ...
                                            <div class="mini-post-info">
                                                <h6 itemprop="headline"><a href="" title="" itemprop="url">Kielbasa turducken jer tongue alcatra</a></h6>
                                        ...
                                        <div class="mini-post-box">
                                            ...
                                            <div class="mini-post-info">
                                                <h6 itemprop="headline"><a href="" title="" itemprop="url">Intrinsicly visualize ent action items</a></h6>
                                                <span class="mini-post-meta">
                                                    <a href="#" title="" itemprop="url"><i class="fa fa-calendar theme-clr"></i> 22 Dec, 2016</a>
                                                </span>
                                            </div>
                                        ...
                                        <div class="mini-post-box">
                                            ...
                                            <div class="mini-post-info">
                                                <h6 itemprop="headline"><a href="=" title="" itemprop="url">11 Rose Gold Homewa Mother's Day</a></h6>
                                                <span class="mini-post-meta">
                                                    <a href="#" title="" itemprop="url"><i class="fa fa-calendar theme-clr"></i> 22 Dec, 2016</a>
                                                </span>
                                            </div>
