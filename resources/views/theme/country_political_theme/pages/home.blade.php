...
@section('content')
            ...
            <div id="rev_slider_4_1" class="rev_slider fullscreenbanner" style="display:none;" data-version="5.4.1">
                <ul>
                    <li data-index="rs-1" data-transition="random" data-slotamount="default" data-hideafterloop="0" data-hideslideonmobile="off" data-title="Slide Title" data-easein="Power4.easeInOut" data-easeout="Power4.easeInOut" data-masterspeed="2000"  data-rotate="0"  data-fstransition="random" data-fsmasterspeed="1500" data-fsslotamount="7" data-saveperformance="off" data-param1="" data-param2="" data-param3="" data-param4="" data-param5="" data-param6="" data-param7="" data-param8="" data-param9="" data-param10="" data-description="">
                        <!-- MAIN IMAGE -->
                        <img src="{{asset('theme/country/assets/images/resources/slide1.jpg')}}" alt="" data-bgposition="center center" data-bgfit="cover" data-bgrepeat="no-repeat" data-bgparallax="10" class="rev-slidebg" data-no-retina>
                    ...
                    <li data-index="rs-2" data-transition="random" data-slotamount="default" data-hideafterloop="0" data-hideslideonmobile="off" data-title="Slide Title" data-easein="Power4.easeInOut" data-easeout="Power4.easeInOut" data-masterspeed="2000"  data-rotate="0"  data-fstransition="random" data-fsmasterspeed="1500" data-fsslotamount="7" data-saveperformance="off" data-param1="" data-param2="" data-param3="" data-param4="" data-param5="" data-param6="" data-param7="" data-param8="" data-param9="" data-param10="" data-description="">
                        <!-- MAIN IMAGE -->
                        <img src="{{asset('theme/country/assets/images/resources/slide2.jpg')}}" alt="" data-bgposition="center center" data-bgfit="cover" data-bgrepeat="no-repeat" data-bgparallax="10" class="rev-slidebg" data-no-retina>
    ...
    <section>
        <div class="spacing remove-gap opc9 black-layer2">
            <div class="fixed-bg" style="background-image: url(theme/country/assets/images/parallax1.jpg);"></div>
                ...
                <div class="remove-ext7">
                    <div class="row">
                        <div class="col-md-4 col-sm-6 col-lg-4">
                            <div class="event-box brd-rd5">
                                <div class="event-thumb">
                                    <a href="event-detail.html" title="" itemprop="url"><img src="{{asset('theme/country/assets/images/resources/event-img1-1.jpg')}}" alt="event-img1-1.jpg" itemprop="image"></a>
                                </div>
                        ...
                        <div class="col-md-4 col-sm-6 col-lg-4">
                            <div class="event-box brd-rd5">
                                <div class="event-thumb">
                                    <a href="event-detail.html" title="" itemprop="url"><img src="{{asset('theme/country/assets/images/resources/event-img1-2.jpg')}}" alt="event-img1-2.jpg" itemprop="image"></a>
                                </div>
                                <div class="event-info">
                        ...
                        <div class="col-md-4 col-sm-6 col-lg-4">
                            <div class="event-box brd-rd5">
                                <div class="event-thumb">
                                    <a href="event-detail.html" title="" itemprop="url"><img src="{{asset('theme/country/assets/images/resources/event-img1-3.jpg')}}" alt="event-img1-3.jpg" itemprop="image"></a>
                                </div>
                                <div class="event-info">
                ...
                <div class="remove-ext3 product-wrap style2">
                    <div class="row">
                        <div class="col-md-4 col-sm-6 col-lg-4">
                            <div class="product-box-wrap">
                                <div class="product-box-inner brd-rd5">
                                    <div class="product-thumb brd-rd50"><img src="{{asset('theme/country/assets/images/resources/product-img1-4.jpg')}}" alt="product-img1-4.jpg" itemprop="image">
                        ...
                        <div class="col-md-4 col-sm-6 col-lg-4">
                            <div class="product-box-wrap">
                                <div class="product-box-inner brd-rd5">
                                    <div class="product-thumb brd-rd50"><img src="{{asset('theme/country/assets/images/resources/product-img1-2.jpg')}}" alt="product-img1-2.jpg" itemprop="image">
                                        <div class="product-btns">
                                            <a href="#" title="" itemprop="url"><i class="fa fa-shopping-bag"></i></a>
                                            <a href="#" title="" itemprop="url"><i class="fa fa-heart"></i></a>
                                        </div>
                        ...
                        <div class="col-md-4 col-sm-6 col-lg-4">
                            <div class="product-box-wrap">
                                <div class="product-box-inner brd-rd5">
                                    <div class="product-thumb brd-rd50"><img src="{{asset('theme/country/assets/images/resources/product-img1-6.jpg')}}" alt="product-img1-6.jpg" itemprop="image">
                                        <div class="product-btns">
                                            <a href="#" title="" itemprop="url"><i class="fa fa-shopping-bag"></i></a>
                                            <a href="#" title="" itemprop="url"><i class="fa fa-heart"></i></a>
                                        </div>
                                ...
                                <div class="row">
                                    <div class="col-md-6 col-sm-6 col-lg-6">
                                        <div class="post-box2 brd-rd5">
                                            <a href="blog-detail.blade.php" title="" itemprop="url"><img src="{{asset('theme/country/assets/images/resources/post-img2-1.jpg')}}" alt="post-img2-1.jpg" itemprop="image"></a>
                                            <span class="post-author"><img class="brd-rd50" src="{{asset('theme/country/assets/images/resources/post-author-img1-2.jpg')}}" alt="post-author-img1-2.jpg" itemprop="image"> <a href="#" title="" itemprop="url">Treandy Themes</a></span>
                                    ...
                                    <div class="col-md-6 col-sm-6 col-lg-6">
                                        <div class="post-box2 brd-rd5">
                                            <a href="blog-detail.blade.php" title="" itemprop="url"><img src="{{asset('theme/country/assets/images/resources/post-img2-3.jpg')}}" alt="post-img2-3.jpg" itemprop="image"></a>
                                            <span class="post-author"><img class="brd-rd50" src="{{asset('theme/country/assets/images/resources/post-author-img1-3.jpg')}}" alt="post-author-img1-3.jpg" itemprop="image"> <a href="#" title="" itemprop="url">Walter Lewis</a></span>
                                            <div class="post-info2">
