						...
						<div class="swiper-wrapper">
							<div class="swiper-slide">
								<div class="statement-thumb">
									<a href="#"><img src="{{asset('theme/political/assets/images/homepage5/statement/01.jpg')}}" alt="thumb"></a>
								</div>
							</div>
							<div class="swiper-slide">
								<div class="statement-thumb">
									<a href="#"><img src="{{asset('theme/political/assets/images/homepage5/statement/02.jpg')}}" alt="thumb"></a>
								</div>
							</div>
							<div class="swiper-slide swiper-slide-prev">
								<div class="statement-thumb">
									<a href="#"><img src="{{asset('theme/political/assets/images/homepage5/statement/03.jpg')}}" alt="thumb"></a>
								</div>
							</div>
				...
				<div class="testimonial">
				    ...
				    <div class="swiper-container gallery-thumbs swiper-container-horizontal">
				        <div class="swiper-wrapper" style="transform: translate3d(-100px, 0px, 0px); transition-duration: 0ms;">
				            <div class="swiper-slide" style="width: 100px;"><img src="{{asset('theme/political/assets/images/homepage5/testimonial/01.jpg')}}" alt="thumb"></div>
				            <div class="swiper-slide swiper-slide-prev" style="width: 100px;"><img src="{{asset('theme/political/assets/images/homepage5/testimonial/02.jpg')}}" alt="thumb"></div>
				            <div class="swiper-slide swiper-slide-active" style="width: 100px;"><img src="{{asset('theme/political/assets/images/homepage5/testimonial/03.jpg')}}" alt="thumb"></div>
				            <div class="swiper-slide swiper-slide-next" style="width: 100px;"><img src="{{asset('theme/political/assets/images/homepage5/testimonial/02.jpg')}}" alt="thumb"></div>
				        </div>
				    </div>
				</div><!-- /.testimonial -->
			</div><!-- /.container -->
				...
				<div class="member">
					<div class="member-item">
						<div class="member-item-inner">
							<img src="{{asset('theme/political/assets/images/homepage6/member/01.jpg')}}" alt="member-image">
							<a href="#" class="view-bio">View Bio</a>
						</div><!-- /.member-item-inner -->
					</div><!-- /.member-item -->
					<div class="member-item">
						<div class="member-item-inner">
							<img src="{{asset('theme/political/assets/images/homepage6/member/02.jpg')}}" alt="member-image">
							<a href="#" class="view-bio">View Bio</a>
						</div><!-- /.member-item-inner -->
					</div><!-- /.member-item -->
					<div class="member-item">
						<div class="member-item-inner">
							<img src="{{asset('theme/political/assets/images/homepage6/member/03.jpg')}}" alt="member-image">
							<a href="#" class="view-bio">View Bio</a>
						</div><!-- /.member-item-inner -->
					</div><!-- /.member-item -->
					<div class="member-item">
						<div class="member-item-inner">
							<img src="{{asset('theme/political/assets/images/homepage6/member/04.jpg')}}" alt="member-image">
							<a href="#" class="view-bio">View Bio</a>
						</div><!-- /.member-item-inner -->
					</div><!-- /.member-item -->
					<div class="member-item">
						<div class="member-item-inner">
							<img src="{{asset('theme/political/assets/images/homepage6/member/05.jpg')}}" alt="member-image">
							<a href="#" class="view-bio">View Bio</a>
						</div><!-- /.member-item-inner -->
					</div><!-- /.member-item -->
					<div class="member-item">
						<div class="member-item-inner">
							<img src="{{asset('theme/political/assets/images/homepage6/member/06.jpg')}}" alt="member-image">
							<a href="#" class="view-bio">View Bio</a>
						</div><!-- /.member-item-inner -->
					</div><!-- /.member-item -->
					<div class="member-item">
						<div class="member-item-inner">
							<img src="{{asset('theme/political/assets/images/homepage6/member/07.jpg')}}" alt="member-image">
							<a href="#" class="view-bio">View Bio</a>
						</div><!-- /.member-item-inner -->
					</div><!-- /.member-item -->
					<div class="member-item">
						<div class="member-item-inner">
							<img src="{{asset('theme/political/assets/images/homepage6/member/08.jpg')}}" alt="member-image">
							<a href="#" class="view-bio">View Bio</a>
						</div><!-- /.member-item-inner -->
					</div><!-- /.member-item -->
					<div class="member-item">
						<div class="member-item-inner">
							<img src="{{asset('theme/political/assets/images/homepage6/member/09.jpg')}}" alt="member-image">
							<a href="#" class="view-bio">View Bio</a>
						</div><!-- /.member-item-inner -->
					</div><!-- /.member-item -->
					<div class="member-item">
						<div class="member-item-inner">
							<img src="{{asset('theme/political/assets/images/homepage6/member/10.jpg')}}" alt="member-image">
							<a href="#" class="view-bio">View Bio</a>
						</div><!-- /.member-item-inner -->
					</div><!-- /.member-item -->
