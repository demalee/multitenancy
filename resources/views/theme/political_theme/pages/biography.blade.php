						...
						<div id="childhood" class="childhood bga-item">
							<div class="bpitem">
								...
								<div class="bio-wrapper row">
									...
									<div class="col-md-6">
										<div class="bio-thumb">
											<img src="{{asset('theme/political/assets/images/biography/01.jpg')}}" alt="thumb">
										</div>
									</div>
								</div>
							</div>
							<div class="bpitem">
								...
								<div class="bio-wrapper row">
									<div class="col-md-6">
										<div class="bio-thumb">
											<img src="{{asset('theme/political/assets/images/biography/02.jpg')}}" alt="thumb">
										</div>
									</div>
									<div class="col-md-6">
										<div class="bpitem-content">
						...
						<div id="sports" class="sports bga-item">
							<div class="bpitem">
								...
								<div class="bio-wrapper row">
									...
									<div class="col-md-6">
										<div class="bio-thumb">
											<img src="{{asset('theme/political/assets/images/biography/03.png')}}" alt="thumb">
										</div>
									</div>
								</div>
							</div>
						...
						<div id="education" class="education bga-item">
							<div class="bpitem">
								...
								<div class="bio-wrapper row">
									...
									<div class="col-md-6">
										<div class="bio-thumb">
											<img src="{{asset('theme/political/assets/images/biography/04.jpg')}}" alt="thumb">
										</div>
									</div>
								</div>
							</div>
							<div class="bpitem">
								...
								<div class="bio-wrapper row">
									<div class="col-md-6">
										<div class="bio-thumb">
											<img src="{{asset('theme/political/assets/images/biography/05.jpg')}}" alt="thumb">
										</div>
									</div>
									<div class="col-md-6">
										<div class="bpitem-content">
