...
@section('content')
                    ...
                    <div class="remove-ext3">
                        <div class="row">
                            <div class="col-md-4 col-sm-6 col-lg-4">
                                <div class="team-box brd-rd5">
                                    <div class="team-thumb">
                                        <a href="volunteer-detail.blade.php" title="" itemprop="url"><img src="assets/images/resources/member-img1.jpg" alt="member-img1.jpg" itemprop="image"></a>
                                    </div>
                                    <div class="team-info">
                                        <h5 itemprop="headline"><a href="volunteer-detail.blade.php" title="" itemprop="url">Philip Waren</a></h5>
                            ...
                            <div class="col-md-4 col-sm-6 col-lg-4">
                                <div class="team-box brd-rd5">
                                    <div class="team-thumb">
                                        <a href="volunteer-detail.blade.php" title="" itemprop="url"><img src="assets/images/resources/member-img2.jpg" alt="member-img2.jpg" itemprop="image"></a>
                                    </div>
                                    <div class="team-info">
                                        <h5 itemprop="headline"><a href="volunteer-detail.blade.php" title="" itemprop="url">Rubén Moya</a></h5>
                            ...
                            <div class="col-md-4 col-sm-6 col-lg-4">
                                <div class="team-box brd-rd5">
                                    <div class="team-thumb">
                                        <a href="volunteer-detail.blade.php" title="" itemprop="url"><img src="assets/images/resources/member-img3.jpg" alt="member-img3.jpg" itemprop="image"></a>
                                    </div>
                                    <div class="team-info">
                                        <h5 itemprop="headline"><a href="volunteer-detail.blade.php" title="" itemprop="url">David Bravo</a></h5>
        ...
        <section>
            <div class="spacing top-spac90 theme-bg-layer opc9">
                <div class="fixed-bg2 pattern-bg" style="background-image: url(assets/images/pattern1.png);"></div>
                <div class="container">
                    <div class="row">
        ...
        <section>
            <div class="spacing no-spacing gray-layer opc8">
                <div class="fixed-bg pattern-bg" style="background-image: url(assets/images/pattern2.png);"></div>
                <div class="container">
                    <div class="row">
                        <div class="col-md-6 col-sm-12 col-lg-6">
                            <div class="chairman-message">
                                ...
                                <img class="chairman-sign" src="assets/images/chairman-sign.png" alt="chairman-sign.png" itemprop="image">
                            </div><!-- Chairman Message -->
                        </div>
                        <div class="col-md-6 col-sm-12 col-lg-6">
                            <div class="chairman-img text-center overlap115">
                                <img src="assets/images/resources/chairman-img.png" alt="chairman-img.png" itemprop="image">
                            </div>
                        </div>
                    </div>
                </div>
