				...
				<div class="row">
					<div class="col-xl-12">
						...
						<div class="events-deatils-meta">
							...
							<span><i class="far fa-clock"></i> 10:30 am - 12:00 pm</span>
							<span><i class="far fa-map"></i> 368 Sarah Drive, Lafayette, LA 70506</span>
						</div>
						<div class="row mb-30">
							<div class="col-xl-4 col-lg-4 cl-md-4">
								<div class="event-details-text mb-20">
									<h2>Keeping Nodejs Fast Tools Techniques And TipMaking High Performance.</h2>
								</div>
							</div>
							<div class="col-xl-8 col-lg-8 cl-md-8">
								<div class="event-details-info mb-20">
									...
									<p>There are must explain to you how all this mistaken idea of denouncing pleasure and praising pain was born and I will give you a complete account of the system, and expound thactual teachings of the great explorer of the truth.</p>
								</div>
							</div>
						</div>
						<div class="row mb-10">
