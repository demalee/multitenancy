    ...
    <div class="sab_banner overlay">
        <div class="container">
            <div class="sab_banner_text">
                <h2 contenteditable="true">Health & Care Department</h2>
                <ul class="breadcrumb">
                    <li class="breadcrumb-item" contenteditable="true"> <a href="#">Home</a></li>
                    <li class="breadcrumb-item" contenteditable="true"><a href="#">Goverment Department</a></li>
                    <li class="breadcrumb-item active" contenteditable="true"> Health & Care Depatment</li>
                </ul>
            </div>
        </div>
    </div>
        ...
        <div class="container">
            <div class="city_health2_fig">
                <figure class="box">
                    ...
                    <img src="{{asset('theme/local/extra-images/health01.jpg')}}" alt="">
                </figure>
            </div>
            <div class="row">
                <div class="col-md-3">
                    <div class="sidebar_widget">
                        ...
                        <div class="side_submit_form">
                            <h4 class="sidebar_title" contenteditable="true">Get In Touch</h4>
                            <div class="side_submit_field">
                                ...
                                <a class="theam_btn btn2" href="#">Submit Now</a>
                            </div>
                        </div>
                        ...
                        <div class="side_contact_info">
                            ...
                            <ul class="side_contact_list">
                                ...
                                <li>
                                    <div class="side_contact_text">
                                        <h6 contenteditable="true"><i class="fa fa-envelope"></i>Email Address</h6>
                    ...
                    <div class="city_health2_row">
                        ...
                        <div class="city_health2_text text2">
                            ...
                            <ul class="city_local_link">
                                <li><a href="#" contenteditable="true">Lorem quis bibendum auctor, nisi elit consequat </a></li>
                                <li><a href="#" contenteditable="true">Lorem quis bibendum auctor, nisi elit consequat </a></li>
                                <li><a href="#" contenteditable="true">Lorem quis bibendum auctor, nisi elit consequat </a></li>
                                <li><a href="#" contenteditable="true">Lorem quis bibendum auctor, nisi elit consequat </a></li>
                                <li class="margin0" contenteditable="true"><a href="#">Lorem quis bibendum auctor, nisi elit consequat </a></li>
                                <li class="margin0" contenteditable="true"><a href="#">Lorem quis bibendum auctor, nisi elit consequat </a></li>
                            </ul>
                        </div>
                        <!--CITY HEALTH TEXT END-->
                        ...
                        <div class="city_health2_text text2 margin0">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="accordion">
                                        <div class="accordion-section">
                                            <a class="accordion-section-title" href="#accordion-1">Lorem quis bibendum auctor, consequat </a>
                                        ...
                                        <div class="accordion-section">
                                            <a class="accordion-section-title" href="#accordion-2">Lorem quis bibendum auctor, consequat </a>
                                        ...
                                        <div class="accordion-section">
                                            <a class="accordion-section-title" href="#accordion-3">Lorem quis bibendum auctor, consequat </a>
                                ...
                                <div class="col-md-6">
                                    <div class="accordion">
                                        <div class="accordion-section">
                                            <a class="accordion-section-title" href="#accordion-4">Lorem quis bibendum auctor, consequat </a>
                                        ...
                                        <div class="accordion-section">
                                            <a class="accordion-section-title" href="#accordion-5">Lorem quis bibendum auctor, consequat </a>
                                        ...
                                        <div class="accordion-section">
                                            <a class="accordion-section-title" href="#accordion-6">Lorem quis bibendum auctor, consequat </a>
