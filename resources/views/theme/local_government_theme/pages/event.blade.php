...
<!-- Mirrored from kodeforest.net/html/baldiyat/event.blade.php by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 09 Nov 2020 07:45:48 GMT -->
<head>
        <meta charset="utf-8">
        <meta http-equiv="X-UA-Compatible" content="IE=edge">
        <meta name="viewport" content="width=device-width, initial-scale=1">
        <title>News and Event Baldiyat - Local Government Template</title>
        <!-- Bootstrap core CSS -->
		...
		<!-- Custom Main StyleSheet CSS -->
        <link href="../../public/css/svg-icon.css" rel="stylesheet">
        <!-- Color CSS -->
				...
				<div class="container">
					<div class="sab_banner_text">
						...
						<ul class="breadcrumb">
						  ...
						  <li class="breadcrumb-item active">Upcomig Event</li>
						</ul>
					</div>
				</div>
			</div>
								...
								<div class="city_event2_list">
									...
									<div class="city_event2_text">
										...
										<ul>
											...
											<li><a href="#"><i class="fa fa-map-marker"></i>10th Floors, Pantero Hotel</a></li>
										</ul>
									</div>
						...
						<div class="col-md-4 col-sm-6">
							<div class="city_event2_fig">
								...
								<div class="city_event2_list">
									...
									<div class="city_event2_text">
										<span>Conference</span>
										<h4><a href="#">Annual Leadership Retreat</a></h4>
										<ul>
											<li><a href="#"><i class="fa fa-microphone"></i>John Doe</a></li>
											<li><a href="#"><i class="fa fa-clock-o"></i>10.00AM</a></li>
											<li><a href="#"><i class="fa fa-map-marker"></i>10th Floors, Pantero Hotel</a></li>
						...
						<div class="col-md-4 col-sm-6">
							<div class="city_event2_fig">
								...
								<div class="city_event2_list">
									...
									<div class="city_event2_text">
										<span>Conference</span>
										<h4><a href="#">Control in Our Tax Code</a></h4>
										<ul>
											<li><a href="#"><i class="fa fa-microphone"></i>John Doe</a></li>
											<li><a href="#"><i class="fa fa-clock-o"></i>10.00AM</a></li>
											<li><a href="#"><i class="fa fa-map-marker"></i>10th Floors, Pantero Hotel</a></li>
						...
						<div class="col-md-4 col-sm-6">
							<div class="city_event2_fig">
								...
								<div class="city_event2_list">
									...
									<div class="city_event2_text">
										<span>Conference</span>
										<h4><a href="#">Empowerment Conference</a></h4>
										<ul>
											<li><a href="#"><i class="fa fa-microphone"></i>John Doe</a></li>
											<li><a href="#"><i class="fa fa-clock-o"></i>10.00AM</a></li>
											<li><a href="#"><i class="fa fa-map-marker"></i>10th Floors, Pantero Hotel</a></li>
...
<!-- Mirrored from kodeforest.net/html/baldiyat/event.blade.php by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 09 Nov 2020 07:45:59 GMT -->
</html>
