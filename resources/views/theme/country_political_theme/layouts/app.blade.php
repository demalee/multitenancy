...
<head>
    ...
    <link rel="stylesheet" href="{{asset('theme/country/assets/css/webfonts.css')}}"><!-- Font Awesome -->
    <link rel="stylesheet" href="{{asset('theme/country/assets/css/style.css')}}"><!-- Style -->
    <link rel="stylesheet" href="{{asset('theme/country/assets/css/responsive.css')}}"><!-- Responsive -->
    <link rel="stylesheet" href="{{asset('theme/country/assets/css/color.css')}}"><!-- Default Color Scheme -->

    <!-- REVOLUTION STYLE SHEETS -->
    <link rel="stylesheet" href="{{asset('theme/country/assets/css/revolution/settings.css')}}">
    <!-- REVOLUTION LAYERS STYLES -->
    <link rel="stylesheet" href="{{asset('theme/country/assets/css/revolution/layers.css')}}">
    <link rel="stylesheet" href="{{asset('theme/country/assets/css/revolution/navigation.css')}}">
</head>
<body itemscope>
<main>
...
<script src="{{asset('theme/country/assets/js/jquery.min.js')}}"></script>
<script src="{{asset('theme/country/assets/js/bootstrap.min.js')}}"></script>
<script src="{{asset('theme/country/assets/js/plugins.js')}}"></script>
<script src="{{asset('theme/country/assets/js/custom-scripts.js')}}"></script>

<script src="{{asset('theme/country/assets/js/revolution/jquery.themepunch.tools.min.js')}}"></script>
<script src="{{asset('theme/country/assets/js/revolution/jquery.themepunch.revolution.min.js')}}"></script>

<!-- SLIDER REVOLUTION 5.0 EXTENSIONS  (Load Extensions only on Local File Systems !  The following part can be removed on Server for On Demand Loading) -->
<script src="{{asset('theme/country/assets/js/revolution/extensions/revolution.extension.actions.min.js')}}"></script>
<script src="{{asset('theme/country/assets/js/revolution/extensions/revolution.extension.carousel.min.js')}}"></script>
<script src="{{asset('theme/country/assets/js/revolution/extensions/revolution.extension.kenburn.min.js')}} "></script>
<script src="{{asset('theme/country/assets/js/revolution/extensions/revolution.extension.layeranimation.min.js')}}"></script>
<script src="{{asset('theme/country/assets/js/revolution/extensions/revolution.extension.migration.min.js')}}"></script>
<script src="{{asset('theme/country/assets/js/revolution/extensions/revolution.extension.navigation.min.js')}}"></script>
<script src="{{asset('theme/country/assets/js/revolution/extensions/revolution.extension.parallax.min.js')}}"></script>
