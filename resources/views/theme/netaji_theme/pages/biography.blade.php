...
@section('content')
					...
					<div class="col-xl-12">
						<div class="breadcrumb-text text-center">
							...
							<ul class="breadcrumb-menu">
								...
								<li><span contenteditable="true">Biography</span></li>
							</ul>
						</div>
					</div>
				</div>
		...
		<!-- about-me-area-start -->
		<div class="about-me-area pt-120 pb-90">
			<div class="container">
				<div class="row">
					...
					<div class="col-xl-5 col-lg-5">
						<div class="about-me-wrapper2 mb-30">
							<div class="about-me-text about2-me-text">
								<span contenteditable="true">About me</span>
								<h2 contenteditable="true">My mission i want to change my country and poor people</h2>
								<p contenteditable="true">But I must explain to you how all this mistaken idea of de- nouncing plsure and praising pain was born and I will give you a complete account of the system and expound the actual teachings of the great explorer of the truth the master-builder of human happiness one rejects.</p>
		...
		<!-- video-area-start -->
		<div class="video-area pt-120 pb-90 gray-bg">
			<div class="container">
				<div class="row">
					<div class="col-xl-5 col-lg-5">
						<div class="video2-wrapper">
							<div class="video-text video2-text mb-30">
								<span contenteditable="true">Watch video</span>
								<h1 contenteditable="true">The job of a leader is love country & people of the country</h1>
								<p contenteditable="true">But I must explain to you how all this mistaken idea of de- nouncing pleasure and praising pain was born and I will give you a complete account of the system, and expound the actual teachings of the great. </p>
							</div>
						</div>
					</div>
					<div class="col-xl-7 col-lg-7">
		...
		<div class="political-area pt-110 pb-120" style="background-image:url(img/bg/9.jpg)">
			<div class="container">
				<div class="row">
					<div class="col-xl-12">
						<div class="section-title section2-title text-center white-text mb-60">
							<span contenteditable="true">Political resume</span>
							<h1 contenteditable="true">I have lot of experience and have done <br> many work. Let’s see my resume</h1>
						</div>
					</div>
				</div>
					...
					<div class="row">
						<div class="col-xl-4 col-lg-4 col-md-3">
							<div class="political-text mb-10">
								<h3 contenteditable="true">Student Leader</h3>
								<span contenteditable="true">2014 - 2015</span>
							</div>
						</div>
						<div class="col-xl-5 col-lg-5 col-md-5">
							<div class="political-info mb-10">
								<p contenteditable="true">But I must explain to you how all this mistaken idea of nouncing pleasure and praising pain was.</p>
							</div>
						</div>
						<div class="col-xl-3 col-lg-3 col-md-4">
							<div class="political-button text-md-right mb-10">
				...
				<div class="political-bg mb-20">
					<div class="row">
						<div class="col-xl-4 col-lg-4 col-md-3">
							<div class="political-text mb-10">
								<h3 contenteditable="true">Student Chairman</h3>
								<span contenteditable="true">2015 - 2016</span>
							</div>
						</div>
						<div class="col-xl-5 col-lg-5 col-md-5">
							<div class="political-info mb-10">
				...
				<div class="row">
					<div class="col-xl-12">
						<div class="political-resume-button mt-60 text-center">
		...
		<!-- counter-area-start -->
		<div class="counter-area pt-140 pb-110 gray-bg">
			<div class="container">
				<div class="row">
					<div class="col-xl-3 cl-lg-3 col-md-6">
						<div class="counter-wrapper text-center mb-30">
							<div class="counter-text counter2-text">
		...
		<!-- visited-country-start -->
		<div class="visited-country-area pt-115 pb-120">
			<div class="container">
				<div class="row">
					<div class="col-xl-12">
						<div class="section-title section2-title text-center mb-60">
							<span contenteditable="true">Tour of Republic</span>
							<h1 contenteditable="true">Visited for government publication <br> in other country</h1>
						</div>
					</div>
				</div>
					...
					<div class="row no-gutters">
						<div class="col-xl-4 col-lg-4 col-md-4">
							<div class="visited-country-wrapper text-center">
								...
								<div class="visited-country-text">
									<h3><a href="#" contenteditable="true">South Africa</a></h3>
									<span contenteditable="true">10 Feb 2015</span>
								</div>
							</div>
						</div>
						<div class="col-xl-4 col-lg-4 col-md-4">
							<div class="visited-country-wrapper active text-center">
								...
								<div class="visited-country-text">
									<h3><a href="#" contenteditable="true">Australia</a></h3>
						...
						<div class="col-xl-4 col-lg-4 col-md-4">
							<div class="visited-country-wrapper text-center">
								...
								<div class="visited-country-text">
									<h3><a href="#" contenteditable="true">Canada</a></h3>
									<span contenteditable="true">10 Feb 2015</span>
								</div>
							</div>
						</div>
