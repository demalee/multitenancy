                        ...
                        <div class="col-md-9 col-sm-12 col-lg-9">
                            <div class="post-detail-wrap">
                                <div class="post-detail-thumb">
                                    <img class="brd-rd5" src="assets/images/resources/blog-detail.jpg" alt="blog-detail.jpg" itemprop="image">
                                </div>
                                <div class="post-detail-inner">
                                    ...
                                    <div class="gallery gallery-columns-3">
                                        <div class="gallery-item">
                                            <a class="brd-rd5" data-fancybox="gallery" href="assets/images/resources/single-gallery-img1.jpg" title="" itemprop="url"><img src="assets/images/resources/single-gallery-img1.jpg" alt="single-gallery-img1.jpg" itemprop="image"></a>
                                        </div>
                                        <div class="gallery-item">
                                            <a class="brd-rd5" data-fancybox="gallery" href="assets/images/resources/single-gallery-img2.jpg" title="" itemprop="url"><img src="assets/images/resources/single-gallery-img2.jpg" alt="single-gallery-img2.jpg" itemprop="image"></a>
                                        </div>
                                        <div class="gallery-item">
                                            <a class="brd-rd5" data-fancybox="gallery" href="assets/images/resources/single-gallery-img3.jpg" title="" itemprop="url"><img src="assets/images/resources/single-gallery-img3.jpg" alt="single-gallery-img3.jpg" itemprop="image"></a>
                                        </div>
                                    </div>
                                    <p itemprop="description">Delightful remarkably mr on announcing themselves entreaties favourable. About to in so terms voice at. Equal an would is found seems of. The particular friendship one sufficient terminated frequently themselves. It more shed went up is roof if loud case. Delay music in lived noise an. Beyond genius really enough passed is up.</p>
                                    <p itemprop="description">Incommode he depending do frankness remainder to. Edward day almost active him friend thirty piqued. People as period twenty my extent as. Set was better abroad ham plenty secure had horses. Admiration has sir decisively excellence say everything inhabiting acceptance. Sooner settle add put you sudden him.</p>
                                ...
                                <div class="widget-box">
                                    ...
                                    <div class="posts-wrap">
                                        <div class="mini-post-box">
                                            <a class="brd-rd5" href="blog-detail.blade.php" title="" itemprop="url"><img src="assets/images/resources/mini-post-img1.jpg" alt="mini-post-img1.jpg" itemprop="image"></a>
                                            <div class="mini-post-info">
                                                <h6 itemprop="headline"><a href="blog-detail.blade.php" title="" itemprop="url">Kielbasa turducken jer tongue alcatra</a></h6>
                                        ...
                                        <div class="mini-post-box">
                                            <a class="brd-rd5" href="blog-detail.blade.php" title="" itemprop="url"><img src="assets/images/resources/mini-post-img2.jpg" alt="mini-post-img2.jpg" itemprop="image"></a>
                                            <div class="mini-post-info">
                                                <h6 itemprop="headline"><a href="blog-detail.blade.php" title="" itemprop="url">Intrinsicly visualize ent action items</a></h6>
                                                <span class="mini-post-meta">
                                                    <a href="#" title="" itemprop="url"><i class="fa fa-calendar theme-clr"></i> 22 Dec, 2016</a>
                                                </span>
                                            </div>
                                        ...
                                        <div class="mini-post-box">
                                            <a class="brd-rd5" href="blog-detail.blade.php" title="" itemprop="url"><img src="assets/images/resources/mini-post-img3.jpg" alt="mini-post-img3.jpg" itemprop="image"></a>
                                            <div class="mini-post-info">
                                                <h6 itemprop="headline"><a href="blog-detail.blade.php" title="" itemprop="url">11 Rose Gold Homewa Mother's Day</a></h6>
                                                <span class="mini-post-meta">
                                                    <a href="#" title="" itemprop="url"><i class="fa fa-calendar theme-clr"></i> 22 Dec, 2016</a>
                                                </span>
                                            </div>
