                    ...
                    <div class="row justify-content-center">
                        <div class="col-xl-10 col-lg-9 col-md-12">
                            <div class="hero__caption text-center">
                                ...
                                <p data-animation="fadeInUp" data-delay="0.4s">High-performing products that keep large
                                    turf areas beautiful and healthy-while
                                    saving you time, water and energy.</p>
                                <a href="#" class="hero-btn" data-animation="fadeInUp" data-delay="0.7s">Explore Our
                        ...
                        <div class="row no-gutters">
                            ...
                            <div class="col-xl-6 col-lg-6 col-md-6">
                                <div class="features-caption">
                                    ...
                                    <a href="services.blade.php" class="btn">Get the Service</a>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-xl-6">
                    <div class="single-services mb-30">
                        <div class="row no-gutters">
                            <div class="col-xl-6 col-lg-6 col-md-6">
                                <div class="features-img">
                                    <img src="{{url($THEME_IMG.'gallery/services2.png')}}" alt="">
                                </div>
                            </div>
                            <div class="col-xl-6 col-lg-6 col-md-6">
                                <div class="features-caption">
