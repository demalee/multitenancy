			...
			<div class="product-preview-section row align-items-center no-gutters">
                <div class="col-lg-6">
                    <div class="product-image">
                        <img src="assets/images/product-detail/01.jpg" alt="product">
                    </div>
                </div>
                <div class="col-lg-6">
                            ...
                            <ul class="review-list">
                                <li>
                                    <div class="reviewer-thumb">
                                        <img src="assets/images/product-detail/review/01.jpg" alt="reviewer-image">
                                    </div>
                                ...
                                <li>
                                    <div class="reviewer-thumb">
                                        <img src="assets/images/product-detail/review/02.jpg" alt="reviewer-image">
                                    </div>
                                    <div class="review-content">
                                        <div class="name"><a href="#">Hames Alex</a><span>Jan 8, 2016</span></div>
                                        <p>Dramatic actualize economi soundplatform empowerment. Proactively go forward web service before strategic web service. Professional fashion reliable markets thr</p>
                                ...
                                <li>
                                    <div class="reviewer-thumb">
                                        <img src="assets/images/product-detail/review/03.jpg" alt="reviewer-image">
                                    </div>
                                    <div class="review-content">
                                        <div class="name"><a href="#">Hames Alex</a><span>Jan 8, 2016</span></div>
                                        <p>Dramatic actualize economi soundplatform empowerment. Proactively go forward web service before strategic web service. Professional fashion reliable markets thr</p>
                                ...
                                <li>
                                    <div class="reviewer-thumb">
                                        <img src="assets/images/product-detail/review/04.jpg" alt="reviewer-image">
                                    </div>
                                    <div class="review-content">
                                        <div class="name"><a href="#">Hames Alex</a><span>Jan 8, 2016</span></div>
                                        <p>Dramatic actualize economi soundplatform empowerment. Proactively go forward web service before strategic web service. Professional fashion reliable markets thr</p>
