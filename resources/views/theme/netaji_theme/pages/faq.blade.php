				...
				<div class="row">
					...
					<div class="col-xl-8 col-lg-8 mb-30">
						<div class="question-collapse mb-90">
							<div class="faq-text">
								<h1>Why You Can Join Our Team</h1>
							</div>
							<div id="accordion">
								<div class="card">
							...
							<div id="accordion1">
								...
								<div class="card">
									<div class="card-header" id="heading2">
										<h5 class="mb-0">
											<a class="btn-link collapsed" data-toggle="collapse" data-target="#collapse2" aria-expanded="false" aria-controls="collapse2">
												Lessons Learned While Developing WordPress Plugins
											</a>
										</h5>
									</div>
								...
								<div class="card">
									<div class="card-header" id="heading3">
										<h5 class="mb-0">
											<a class="btn-link collapsed" data-toggle="collapse" data-target="#collapse3" aria-expanded="false" aria-controls="collapse3">
												Creating The Feature Queries Manager DevTools Extension
											</a>
										</h5>
									</div>
								...
								<div class="card">
									<div class="card-header" id="heading4">
										<h5 class="mb-0">
											<a class="btn-link collapsed" data-toggle="collapse" data-target="#collapse4" aria-expanded="false" aria-controls="collapse4">
												Diverse Design Teams To Drive Innovation
											</a>
										</h5>
									</div>
							...
							<div id="accordion2">
								<div class="card">
									<div class="card-header" id="heading5">
										<h5 class="mb-0">
											<a class="btn-link" data-toggle="collapse" data-target="#collapse5" aria-expanded="true" aria-controls="collapse5">
												Building A Central Logging Service In-House
											</a>
										</h5>
									</div>
								...
								<div class="card">
									<div class="card-header" id="heading6">
										<h5 class="mb-0">
											<a class="btn-link collapsed" data-toggle="collapse" data-target="#collapse6" aria-expanded="false" aria-controls="collapse6">
												Lessons Learned While Developing WordPress Plugins
											</a>
										</h5>
									</div>
								...
								<div class="card">
									<div class="card-header" id="heading7">
										<h5 class="mb-0">
											<a class="btn-link collapsed" data-toggle="collapse" data-target="#collapse7" aria-expanded="false" aria-controls="collapse7">
												Creating The Feature Queries Manager DevTools Extension
											</a>
										</h5>
									</div>
								...
								<div class="card">
									<div class="card-header" id="heading8">
										<h5 class="mb-0">
											<a class="btn-link collapsed" data-toggle="collapse" data-target="#collapse8" aria-expanded="false" aria-controls="collapse8">
												Diverse Design Teams To Drive Innovation
											</a>
										</h5>
									</div>
